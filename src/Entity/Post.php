...
class Post
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: Category::class, inversedBy: 'posts', fetch: 'EXTRA_LAZY')]
     ...
     */
    #[ORM\OneToMany(targetEntity: Comment::class, mappedBy: 'post', cascade: ['persist', 'remove'], fetch: 'EXTRA_LAZY', orphanRemoval: true)]
